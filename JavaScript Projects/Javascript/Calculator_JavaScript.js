...
function Input_Digit(digit) {                           //function modifies values each time a button is clicked
...
function Input_Decimal(dot) {                           //function handles decimals
...
function Handle_Operator(Next_Operator) {                            //section handles operators.
...
function Update_Display() {                                         //function updates the screen with the contents of dispaly_value
